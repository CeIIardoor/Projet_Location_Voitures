						...
						<div class="row align-items-center  item mb-4 pb-120 pt-120 " style="background-image:url('{{asset($car->photo)}}'); background-position: center;background-size: cover; ">
							...
							<div class="col-lg-12 ">
								<div class="title justify-content-between d-flex ml-40">
									<h3 class="header-text padding:10px text-white bg-dark text-uppercase ml-30">{{$car->model}}</h3>
									
								</div>
								
								<p style="width: 20%;padding:5px" class="text-white bg-dark mt-30 ml-30 mb-30">
									Prix            :${{$car->price}}<span>/day</span><br>
									Capacité         : {{$car->people}} Person <br>
									Portes            : {{$car->doors}} <br>
									Kilometrage    : {{$car->mileage}} km <br>
