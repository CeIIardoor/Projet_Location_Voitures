				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="{{route('home')}}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{route('showCarsList')}}"> Cars</a><span class="lnr lnr-arrow-right"></span> <a href="{{ route('showAddCar') }}"> Add</a></p>
						</div>											
					</div>
				</div>
			</section>
